...
export const APP_SPLASH_BACKGROUND_COLOR =
	process.env.SPLASH_COLOR || "#8B5CF6";
...
export const CHOOCHOO_TRAIN_METADATA_URI =
	process.env.NEXT_PUBLIC_CHOOCHOO_TRAIN_METADATA_URI;
...
export const MARQUEE_CONFIG = {
	scrollSpeed: parseInt(
		process.env.NEXT_PUBLIC_MARQUEE_SCROLL_SPEED || "10",
		10,
	),
