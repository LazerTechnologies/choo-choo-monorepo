      ...
      <Card.Content className="p-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-shrink-0">
            <div className="w-12 h-12 border-2 border-white rounded-lg overflow-hidden bg-purple-400">
              <Image
                src={nftImage}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <div className="min-w-0 flex-1">
                <Typography
                  variant="label"
                  className="font-semibold !text-white truncate font-comic"
                >
                  {username}
                </Typography>
                <Typography variant="small" className="!text-white opacity-80 truncate font-mono">
                  {truncatedAddress}
                </Typography>
              </div>
            </div>
